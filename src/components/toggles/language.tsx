      ...
      <PopoverContent className='flex w-[150px] flex-col gap-2 px-0 py-2'>
        {locales.map((locale) => (
          <div
            ...
            className='flex cursor-pointer items-center gap-2 px-4 py-2 text-sm transition-colors hover:bg-gray-100 active:bg-gray-200 dark:active:bg-gray-700 dark:hover:bg-gray-800'
          >
